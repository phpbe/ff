<be-head>
    <link type="text/css" rel="stylesheet"
          href="<?php echo \Be\Ff\Be::getProperty('App.System')->getUrl(); ?>/Template/System/css/exception.css">
    <link rel="stylesheet"
          href="<?php echo \Be\Ff\Be::getProperty('App.System')->getUrl(); ?>/Template/System/google-code-prettify/prettify.css"
          type="text/css"/>
    <script type="text/javascript" language="javascript"
            src="<?php echo \Be\Ff\Be::getProperty('App.System')->getUrl(); ?>/Template/System/google-code-prettify/prettify.js"></script>
    <style type="text/css">
        pre.prettyprint {
...
<be-body>
    ...
    <div id="app" v-cloak>
        <?php
        $configSystem = \Be\Ff\Be::getConfig('System.System');
        if ($configSystem->developer) {
            $request = \Be\Ff\Be::getRequest();
            ?>
            <el-alert
